...
def render_physical_grasp_hand(xml_text):
    ...
    _add_text(plugin, "activeStiffness", "20.0 12.0 12.0 12.0")
    _add_text(plugin, "activeDamping", "0.14 0.08 0.08 0.08")
    _add_text(plugin, "activeMaxEffort", "3.0 0.60 0.60 0.60")
    _add_text(plugin, "mimicStiffness", "20.0 10.0 10.0 10.0")
    _add_text(plugin, "mimicDamping", "0.14 0.06 0.06 0.06")
